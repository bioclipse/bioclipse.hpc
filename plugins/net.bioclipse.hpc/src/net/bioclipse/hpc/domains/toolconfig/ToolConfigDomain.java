...
public class ToolConfigDomain {
	...
	public String[] getToolGroupNames() {
		...
		String[] toolGroupNamesArray = HPCUtils.stringListToArray(toolGroupNames);
	...
	public String[] getToolNamesForGroupName(String selectedToolGroupName) {
		...
		String[] toolNamesArray = HPCUtils.stringListToArray(toolNames);
	 ...
	 * used internally by the HPC plugin, given a path to the Galaxy tools
	 * folder
	...
	private Tool initializeToolFromXmlDoc(Document xmlDoc) {
		...
		try {
			// XPath Expressions
			String name = (String) XmlUtils.evalXPathExprToString("/tool/@name", xmlDoc);
			String description = (String) XmlUtils.evalXPathExprToString("/tool/description", xmlDoc);
			String command = (String) XmlUtils.evalXPathExprToString("/tool/command", xmlDoc);
			String interpreter = (String) XmlUtils.evalXPathExprToString("/tool/command/@interpreter", xmlDoc);
